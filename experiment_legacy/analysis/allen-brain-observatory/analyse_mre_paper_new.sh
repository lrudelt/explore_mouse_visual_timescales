...
#$ -wd /data.nst/lucas/history_dependence/signatures_of_temporal_processing_paper_code/cluster-jobs/allen-brain-observatory              # run the job from this directory
...
valid_unit_list=valid_unit_list_allen_bo_movie.tsv # for natural movie new
